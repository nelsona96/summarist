...
> = {
  ...
  second: {
    ...
    details: [
      "of Summarist members <strong>report feeling more productive</strong> after incorporating the service into their daily routine.",
      "of Summarist members have <strong>noticed an improvement</strong> in their overall comprehension and retention of information.",
      "of Summarist members <strong>feel more informed</strong> about current events and industry trends since using the platform.",
    ],
  },
};
      ...
      {data.details.map(
        (detail, index) => (
          <li key={index} className={styles.detailWrapper}>
            ...
            <span dangerouslySetInnerHTML={{ __html: detail }} className={styles.detail} />
          </li>
        ),
      )}
    </ul>
